...
class category : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ice: TextView = findViewById(R.id.iceCoffee)
        ...
        val shack: TextView = findViewById(R.id.Shake)
        shack.setOnClickListener {
            val intent = Intent(this, menu::class.java)
            startActivity(intent)
        }

        val hot: TextView = findViewById(R.id.hotCoffee)
        hot.setOnClickListener {
            val intent = Intent(this, menu::class.java)
            startActivity(intent)
        }

        val snack: TextView = findViewById(R.id.Snack)
        snack.setOnClickListener {
            val intent = Intent(this, snack_menu::class.java)
            startActivity(intent)
        }
